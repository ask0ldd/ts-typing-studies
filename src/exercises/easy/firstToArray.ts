...
type First<T extends readonly unknown[]> = T extends [] ? never : T[0]; // extends used as a comparison operator in some way

//

function firstArray<T extends any[]>(arr: T): First<T> {
...
/*
    ...
    - T extends [] checks if T is an empty array.
*/
